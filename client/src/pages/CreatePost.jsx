...
const CreatePost = () => {
  ...
  if(form.prompt) {
    ...
    const response = await fetch('https://dalle2-mern.onrender.com/api/v1/dalle', {  
      method: 'POST',
      headers: { 
  ...
  const handleSubmit = async(e) => {
    ...
    if(form.prompt && form.photo) {
      ...
      try {
        const response = await fetch('https://dalle2-mern.onrender.com/api/v1/posts', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  <section className='max-w-7xl mx-auto'>
    ...
    <p className='mt-2 text-[#666e75] dark:text-white text-[16px] max-w-[500px]'>Create imaginative and visually stunning images generated through DALL-E AI and share them with the community!</p>
    </div>
    ...
    {/* Showing preview and image generated by the AI */}
    ...
    <div className='mt-10'>
      <p className='mt-2 text-[#666e75] dark:text-white text-[14px]'>Once you have created the image you want, you can share it with others in the community</p>
